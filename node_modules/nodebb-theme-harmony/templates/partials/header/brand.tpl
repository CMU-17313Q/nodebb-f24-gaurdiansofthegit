    ...
    <div class="col-12 d-flex border-bottom pb-3 {{{ if config.theme.centerHeaderElements }}}justify-content-center{{{ end }}}">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <div class="nav-item mx-2">
                <a class="text-reset" itemprop="url">Announcements</a>
            </div>
            <div class="nav-item mx-2">
                <a class="text-reset"  itemprop="url">General Discussion</a>
            </div>
            <div class="nav-item mx-2">
                <a class="text-reset"  itemprop="url">Comments & Feedback</a>
            </div>
            <div class="nav-item mx-2">
                <a class="text-reset"  itemprop="url">Blogs</a>
            </div>
        </div>
