<div class="title-container align-items-center gap-2 d-flex">
	...
	<!-- Add checkbox for anonymous posting -->
	<div class="form-check form-switch">
		<input class="form-check-input" type="checkbox" id="anonymousPost" data-field="anonymousPost">
	...
	<div class="form-check form-switch">
		<input class="form-check-input" type="checkbox" id="privatePost" name="visibility" data-field="privatePost">
