...
define('composer', [
	...
	async function post(post_uuid) {
		...
		// added by copilot
		const anonymousCheckbox = postContainer.find('#anonymousPost').is(':checked'); // Capture the anonymous checkbox
		composer.posts[post_uuid].anonymous = anonymousCheckbox; // Include the anonymous flag in the composer object
		...
		let composerData = {
			// copilot
			//isAnonymous: anonymousCheckbox.is(':checked'), // Include the anonymous flag
			uuid: post_uuid,
		};
		let method = 'post';
		let route = '';
		...
		if (action === 'topics.post') {
			...
			composerData = {
				...
				anonymousCheckbox: composer.posts[post_uuid].anonymous, // Include the anonymous flag
			};
